...
export function GameTutorial({ showTitle = true }: Props) {
  return (
    <div className="space-y-6 text-left">
      ...
      {/* 1. Hide */}
      <section
        className="flex gap-4 rounded-xl border-[3px] p-4"
        style={{
      ...
      >
        ...
        <div>
          <h3 className="font-bold" style={{ color: "var(--pastel-ink)" }}>1. Hide</h3>
      ...
      >
        ...
        <div>
          <h3 className="font-bold" style={{ color: "var(--pastel-ink)" }}>2. Seek</h3>
          <p className="mt-1 text-sm" style={{ color: "var(--pastel-ink-muted)" }}>
      ...
      >
        ...
        <div>
          <h3 className="font-bold" style={{ color: "var(--pastel-ink)" }}>3. Powerups</h3>
          <p className="mt-1 text-sm" style={{ color: "var(--pastel-ink-muted)" }}>
      ...
      >
        ...
        <div>
          <h3 className="font-bold" style={{ color: "var(--pastel-ink)" }}>4. Win</h3>
          <p className="mt-1 text-sm" style={{ color: "var(--pastel-ink-muted)" }}>
